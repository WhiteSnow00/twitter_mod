...
public class lk0
{
    ...
    public lk0(final ProgressBar a) {
        this.a = a;
    }
    
    public void a(final AttributeSet set, int i) {
        final gbt q = gbt.q(((View)this.a).getContext(), set, lk0.c, i);
    ...
    public final Drawable b(final Drawable drawable, final boolean b) {
        if (drawable instanceof jux) {
            final jux jux = (jux)drawable;
            final Drawable a = jux.a();
            if (a != null) {
                jux.b(this.b(a, b));
            }
        }
            ...
            if (drawable instanceof LayerDrawable) {
                ...
                for (int j = n; j < numberOfLayers; ++j) {
                    ...
                    if (Build$VERSION.SDK_INT >= 23) {
                        lk0.a.a(layerDrawable, layerDrawable2, j);
                    }
                }

...
{
    public static final d8q<String, String> a;
    public static Locale b;
    
    static {
        a = new d8q<String, String>();
    }
    
    public static String a(final Context context) {
        final String packageName = context.getPackageName();
        try {
            final nrj a = dux.a(context);
    ...
    public static String b(final Context context, final int n) {
        ...
        if (n == 2) {
            return resources.getString(2131952556);
        }
        if (n != 3) {
            return resources.getString(17039370);
        }
        return resources.getString(2131952546);
    }
    ...
    public static String c(final Context context, final int n) {
        ...
        if (n == 1) {
            return resources.getString(2131952550, new Object[] { a });
        }
        if (n != 2) {
            if (n == 3) {
                return resources.getString(2131952547, new Object[] { a });
            }
            if (n == 5) {
            ...
            switch (n) {
                default: {
                    return resources.getString(2131952554, new Object[] { a });
                }
                case 18: {
                    return resources.getString(2131952559, new Object[] { a });
                }
                case 17: {
            ...
            if (yt8.b(context)) {
                return resources.getString(2131952560);
            }
            return resources.getString(2131952557, new Object[] { a });
        }
    }
    ...
    public static String d(final Context context, final int n) {
        ...
        switch (n) {
            ...
            case 3: {
                return resources.getString(2131952548);
            }
            case 2: {
                return resources.getString(2131952558);
            }
            case 1: {
                return resources.getString(2131952551);
            }
        }
    }
    ...
    public static String e(final Context context, String s, final String s2) {
        ...
        s = (s3 = f(context, s));
        if (s == null) {
            s3 = resources.getString(2131952554);
        }
        return String.format(resources.getConfiguration().locale, s3, s2);
    }
    
    public static String f(final Context context, final String s) {
        final d8q<String, String> a = y2y.a;
        synchronized (a) {
            final Locale b = cf6.a(context.getResources().getConfiguration()).b(0);
            if (!b.equals(y2y.b)) {
                a.clear();
                y2y.b = b;
            }
            final String s2 = a.getOrDefault(s, null);
            if (s2 != null) {
                return s2;
            }
            final int e = d5c.e;

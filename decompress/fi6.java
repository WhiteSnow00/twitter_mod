...
public final class fi6
{
    ...
    public fi6(final fi6 fi6, final Object o) {
        this.a = false;
        this.b = fi6.b;
        this.c = fi6.c;
        this.f(o);
    ...
    public fi6(final String b, final int c, final Object o, final boolean a) {
        this.b = b;
        this.c = c;
        this.a = a;
        this.f(o);
    ...
    public static void d(final Context context, final XmlPullParser xmlPullParser, final HashMap<String, fi6> hashMap) {
        final TypedArray obtainStyledAttributes = context.obtainStyledAttributes(Xml.asAttributeSet(xmlPullParser), as2.T0);
        ...
        if (s != null && s2 != null) {
            hashMap.put(s, new fi6(s, n, s2, (boolean)(n2 != 0)));
        }
        obtainStyledAttributes.recycle();
    }
    
    public static void e(final View view, final HashMap<String, fi6> hashMap) {
        final Class<? extends View> class1 = view.getClass();
        for (final String s : hashMap.keySet()) {
            final fi6 fi6 = hashMap.get(s);
            String h;
            if (!fi6.a) {
                h = hmg.h("set", s);
            }
            ...
            try {
                switch (ib0.E(fi6.c)) {
                    ...
                    case 7: {
                        class1.getMethod(h, Integer.TYPE).invoke(view, fi6.d);
                        continue;
                    }
                    case 6: {
                        class1.getMethod(h, Float.TYPE).invoke(view, fi6.e);
                        continue;
                    }
                    case 5: {
                        class1.getMethod(h, Boolean.TYPE).invoke(view, fi6.g);
                        continue;
                    }
                    case 4: {
                        class1.getMethod(h, CharSequence.class).invoke(view, fi6.f);
                        continue;
                    }
                    case 3: {
                        final Method method = class1.getMethod(h, Drawable.class);
                        final ColorDrawable colorDrawable = new ColorDrawable();
                        colorDrawable.setColor(fi6.h);
                        method.invoke(view, colorDrawable);
                        continue;
                    }
                    case 2: {
                        class1.getMethod(h, Integer.TYPE).invoke(view, fi6.h);
                        continue;
                    }
                    case 1: {
                        class1.getMethod(h, Float.TYPE).invoke(view, fi6.e);
                ...
                final StringBuilder y = pd.y(" Custom Attribute \"", s, "\" not found on ");
                y.append(class1.getName());
                Log.e("TransitionLayout", y.toString());
                ex.printStackTrace();
            }
            catch (final IllegalAccessException ex2) {
                final StringBuilder y2 = pd.y(" Custom Attribute \"", s, "\" not found on ");
                y2.append(class1.getName());
                Log.e("TransitionLayout", y2.toString());
                ex2.printStackTrace();
            }

...
public final class rgv
{
    ...
    public rgv(final Context context, kes a, final ov8 ov8) {
        final PackageInfo f = p70.f(context);
        ma7.R();
        this.a = a;
        ...
        try {
            ...
            try {
                ...
                j2e.a((Closeable)bufferedReader);
            }

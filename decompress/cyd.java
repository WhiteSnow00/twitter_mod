...
public final class cyd implements JsonModelRegistry$Registrar
{
    public final void a(final JsonModelRegistry$b jsonModelRegistry$b) {
        ((JsonModelRegistry$a)jsonModelRegistry$b).b((Class)knt.class, (Class)JsonTopicItem.class, (gra)null);
    }
}

...
public class gk0 extends q16 implements xj0
{
    public AppCompatDelegateImpl E0;
    public final fk0 F0;
    
    public gk0(final Context context, int h) {
        super(context, h(context, h));
        this.F0 = new fk0(this);
        final g g = this.g();
        h = h(context, h);
        ((AppCompatDelegateImpl)g).q1 = h;
        g.m();
    }
    ...
    public final boolean dispatchKeyEvent(final KeyEvent keyEvent) {
        return zpe.b((zpe$a)this.F0, ((Dialog)this).getWindow().getDecorView(), (Window$Callback)this, keyEvent);
    }
    ...
    public final g g() {
        if (this.E0 == null) {
            final int c0 = g.C0;
            this.E0 = new AppCompatDelegateImpl(((Dialog)this).getContext(), ((Dialog)this).getWindow(), this, this);
        }
        return this.E0;
    }

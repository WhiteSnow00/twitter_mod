...
public final class ii6
{
    ...
    public ii6(final Context context, final ConstraintLayout a, int n) {
        this.b = -1;
        this.c = -1;
    ...
    public static final class a
    {
        ...
        public a(final Context context, final XmlPullParser xmlPullParser) {
            ...
            this.c = -1;
            final TypedArray obtainStyledAttributes = context.obtainStyledAttributes(Xml.asAttributeSet(xmlPullParser), as2.h1);
    ...
    public static final class b
    {
        ...
        public b(final Context context, final XmlPullParser xmlPullParser) {
            ...
            this.d = Float.NaN;
            this.e = -1;
            final TypedArray obtainStyledAttributes = context.obtainStyledAttributes(Xml.asAttributeSet(xmlPullParser), as2.l1);
            for (int indexCount = obtainStyledAttributes.getIndexCount(), i = 0; i < indexCount; ++i) {
                final int index = obtainStyledAttributes.getIndex(i);
                if (index == 0) {

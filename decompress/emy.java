...
public final class emy
{
    ...
    public static int a(Context ex, final JobInfo jobInfo) {
        ...
        if (emy.a != null && ((Context)ex).checkSelfPermission("android.permission.UPDATE_DEVICE_STATS") == 0) {
            ex = (InvocationTargetException)emy.b;
            final int n = 0;
            int intValue = 0;
            Label_0097: {
                Label_0095: {
            ...
            ex = (InvocationTargetException)emy.a;
            if (ex != null) {
                try {

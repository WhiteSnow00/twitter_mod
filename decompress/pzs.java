...
public final class pzs
{
    ...
    public static String b(final zps zps) {
        final i8t b = zps.k.b;
        String a;
        if (b != null) {
            a = b.a();
    ...
    public static final class b extends v
    {
        ...
        public final int[] c(final RecyclerView$m recyclerView$m, final View view) {
            int n;
            if (this.g) {
                n = -(pcx.k(this.f).a - view.getRight() - recyclerView$m.getPaddingStart());
            }
            else {
        ...
        public final RecyclerView$x d(final RecyclerView$m recyclerView$m) {
            ...
            return (RecyclerView$x)new u(this, this.f, recyclerView$m) {
                ...
                public final void f(final View view, final RecyclerView$x$a recyclerView$x$a) {
                    ...
                    final int n = this.r.c(this.q, view)[0];
        ...
        public final View e(final RecyclerView$m recyclerView$m) {
            ...
            if (recyclerView$m instanceof LinearLayoutManager) {
                ...
                if (k != null) {
                    ...
                    if (this.g) {
                        if (Math.abs(k.getLeft() - pcx.k(this.f).a) <= n) {

...
public final class ik0 extends PopupWindow
{
    public ik0(final Context context, final AttributeSet set, int resourceId, final int n) {
        super(context, set, resourceId, n);
        final TypedArray obtainStyledAttributes = context.obtainStyledAttributes(set, jee.a1, resourceId, n);
        if (obtainStyledAttributes.hasValue(2)) {
            vrk.a((PopupWindow)this, obtainStyledAttributes.getBoolean(2, false));
        }

...
public final class v63
{
    ...
    public v63(final int c) {
        this.a = null;
        this.c = c;
        this.d = true;
        this.e = true;
        this.b = new AtomicReference<a>(v63.a.a(64));
    }
    
    public v63(final v63 a, final boolean d, int a2, final boolean e, final a a3) {
        this.a = a;
        this.c = a2;
        this.d = d;
        this.e = e;
    ...
    public final int c(int i) {
        ...
        if (i >= g << 3) {
            if (this.e && g > 1024) {
                final StringBuilder f2 = ehk.f("Spill-over slots in symbol table with ");
                f2.append(this.k);
                f2.append(" entries, hash area of ");
                f2.append(this.g);
                f2.append(" slots is now full (all ");
                f2.append(this.g >> 3);
                f2.append(" slots -- suspect a DoS attack based on hash collisions.");
                f2.append(" You can disable the check via `JsonFactory.Feature.FAIL_ON_SYMBOL_HASH_OVERFLOW`");
    ...
    public final String f(String a, int[] f, int n) {
        ...
        if (this.o) {
            ...
            if (g2 > 65536) {
                ...
                if (n2 != k) {
                    throw new IllegalStateException(mw.z("Failed rehash(): old count=", k, ", copyCount=", n2));
                }
            }
        }
        if (this.d) {
    ...
    public final String toString() {
        ...
        return String.format("[%s: size=%d, hashSize=%d, %d/%d/%d/%d pri/sec/ter/spill (=%s), total:%d]", v63.class.getName(), this.k, this.g, n, n3, n6, n8, n + n3 + n6 + n8, n10);
    }
    ...
    public static final class a
    {
        ...
        public static a a(final int n) {
            final int n2 = n << 3;
            return new a(n, v63.b(n), new int[n2], new String[n << 1], n2 - n, n2);
        }
    }
}

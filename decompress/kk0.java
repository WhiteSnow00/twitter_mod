...
public class kk0
{
    ...
    public kk0(final ProgressBar a) {
        this.a = a;
    }
    
    public void a(final AttributeSet set, int i) {
        final kat q = kat.q(((View)this.a).getContext(), set, kk0.c, i);
    ...
    public final Drawable b(final Drawable drawable, final boolean b) {
        if (drawable instanceof qtx) {
            final qtx qtx = (qtx)drawable;
            final Drawable a = qtx.a();
            if (a != null) {
                qtx.b(this.b(a, b));
            }
        }
            ...
            if (drawable instanceof LayerDrawable) {
                ...
                for (int j = n; j < numberOfLayers; ++j) {
                    ...
                    if (Build$VERSION.SDK_INT >= 23) {
                        kk0.a.a(layerDrawable, layerDrawable2, j);
                    }
                }

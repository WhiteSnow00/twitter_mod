...
public final class qcz implements b5j<pmz>
{
    ...
    static {
        ...
        Collections.unmodifiableMap((Map<?, ?>)new HashMap<Object, Object>(hashMap7));
        final cry cry8 = new cry(8, f0);
        final HashMap hashMap8 = new HashMap();
        awg.i(cry8, hashMap8, cry8, hashMap8);
    }

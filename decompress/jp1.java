...
public abstract class jp1
{
    ...
    public jp1(final Context context, final AttributeSet set) {
        this.c = new int[0];
        final int dimensionPixelSize = context.getResources().getDimensionPixelSize(2131166646);
        final TypedArray d = uls.d(context, set, lai.K0, 2130968910, 2132019358, new int[0]);
        this.a = hog.c(context, d, 8, dimensionPixelSize);
        this.b = Math.min(hog.c(context, d, 7, 0), this.a / 2);
        this.e = d.getInt(4, 0);
        this.f = d.getInt(1, 0);
        if (!d.hasValue(2)) {
            this.c = new int[] { ak1.i(context, 2130968973, -1) };
        }
        ...
        if (d.hasValue(6)) {
            ...
            this.d = ak1.f(this.d, (int)(float1 * 255.0f));
        }
        d.recycle();
    }
}

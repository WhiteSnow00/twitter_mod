    ...
    public static b a(final XmlPullParser xmlPullParser, final Resources resources) throws XmlPullParserException, IOException {
        ...
        if (next == 2) {
            ...
            if (xmlPullParser.getName().equals("font-family")) {
                final TypedArray obtainAttributes = resources.obtainAttributes(Xml.asAttributeSet(xmlPullParser), sh4.F0);
                ...
                if (string != null && string2 != null && string3 != null) {
                    ...
                    final Object o = new ikb.ikb$e(new bkb(string, string2, string3, (List)b(resources, resourceId)), integer, integer2, string4);
                    return (b)o;
                }
                ...
                while (xmlPullParser.next() != 3) {
                    ...
                    if (xmlPullParser.getName().equals("font")) {
                        final TypedArray obtainAttributes2 = resources.obtainAttributes(Xml.asAttributeSet(xmlPullParser), sh4.G0);
                        int n = 8;
                ...
                if (!list.isEmpty()) {
                    final Object o = new ikb.ikb$c((d[])list.toArray(new d[0]));
                    return (b)o;
                }
            }
            else {

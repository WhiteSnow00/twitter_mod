...
public final class l3s extends zoc
{
    public final SwitchAccountTypeBottomSheetDialogArgs F0;
    public final h3s G0;
    
    public l3s(final p66 p3, final SwitchAccountTypeBottomSheetDialogArgs f0, final h3s g0) {
    ...
    public final void b(final x66 x66, final int n) {
        final x66 h = x66.h(-252296300);
        final n96$b a = n96.a;
        m3s.b(this.F0.getAccountType(), this.G0, (hv8)null, h, 64, 4);
        final lxo k = h.k();
        if (k != null) {

...
public final class gjo implements g5o
{
    ...
    public gjo(final saw a, final z01 b, final Context c) {
        zzd.f((Object)a, "userEventReporter");
        zzd.f((Object)b, "spaceComponentPrefixDispatcher");
        zzd.f((Object)c, "applicationContext");
        this.a = a;
        this.b = b;
        this.c = c;
    ...
    public static void F(final gjo gjo, final String s, final String s2, final String s3, lev lev, String s4, final int n) {
        if ((n & 0x8) != 0x0) {
            lev = null;
        }
        if ((n & 0x10) != 0x0) {
        ...
        Objects.requireNonNull(gjo);
        gjo.E("", s, s2, s3, lev, s4);
    }
    
    public static /* synthetic */ void G(final gjo gjo, final String s, final String s2, final String s3, final String s4, lev lev, final int n) {
        if ((n & 0x10) != 0x0) {
            lev = null;
        }
        gjo.E(s, s2, s3, s4, lev, null);
    }
    
    public static void H(final gjo gjo, final String s, final String s2, final String s3, final String s4, final String s5, String s6, String s7, String s8, List list, String s9, Integer n, String s10, boolean b, lev lev, Boolean b2, String s11, String s12, String s13, Boolean b3, final int n2) {
        if ((n2 & 0x20) != 0x0) {
            s6 = null;
        }
        if ((n2 & 0x40) != 0x0) {
        ...
        Objects.requireNonNull(gjo);
        xw0.c((rj)new fjo(s6, gjo, s7, s8, s2, s3, s4, s5, s, lev, s9, n, s10, b2, s11, b, b3, s12, s13, list));
    }
    
    public static void T(final gjo gjo, final String s, String m1, final String s2, final String s3, String s4, String s5, Integer n, String s6, int i) {
        String s7;
        if ((i & 0x2) != 0x0) {
            s7 = "";
        }
        ...
        final Object systemService = gjo.c.getSystemService("audio");
        zzd.d(systemService, "null cannot be cast to non-null type android.media.AudioManager");
        ...
        if (Build$VERSION.SDK_INT >= 23) {
            ...
            if (devices != null) {
                ...
                for (length = devices.length, i = 0; i < length; ++i) {
                    list.add(gjo.y(devices[i]));
                }
                m1 = or4.M1((Iterable)or4.A1((Iterable)list), (CharSequence)null, (CharSequence)null, (CharSequence)null, (rtb)hjo.C0, 31);
            }
            else {
                m1 = null;
            }
            if (devices != null) {
                ...
                while (true) {
                    ...
                    if (zzd.a((Object)gjo.y(devices[i]), (Object)"builtin") ^ true) {
                        b2 = true;
                        break;
                    }
                    ++i;
        ...
        H(gjo, "audiospace", s, s7, s8, s3, s4, null, null, null, s5, n, s6, false, null, (Boolean)value, m1, null, null, null, 471232);
    }
    
    public static void b0(final gjo gjo, String s, final String s2, String s3, final int n) {
        if ((n & 0x1) != 0x0) {
            s = "";
        }
        String s4;
        ...
        if (s3 != null) {
            ...
            lev.a = Long.parseLong(s3);
            lev.c = 36;
            u0 = tdy.u0((Object)lev);
        }
        else {
            u0 = null;
        }
        H(gjo, "audiospace", "topics_browse", s, s4, s2, null, null, null, u0, null, null, null, false, null, null, null, null, null, null, 524000);
    }
    
    public final String A(final yvt yvt) {
        final int ordinal = ((Enum)yvt).ordinal();
        String s;
        if (ordinal != 0) {
            if (ordinal != 1) {
                if (ordinal != 2) {
    ...
    public final void D(final yvt yvt) {
        H(this, "audiospace", this.A(yvt), "", "dock", "click", null, null, null, null, null, null, null, false, null, null, null, null, null, null, 524256);
    }
    
    public final void E(final String s, final String s2, final String s3, final String s4, final lev lev, final String s5) {
        H(this, "audiospace", s, s2, s3, s4, null, null, null, null, null, null, null, false, lev, null, null, s5, null, null, 450528);
    }
    
    public final void I(final String s, final String s2, final boolean b) {
        zzd.f((Object)s, "hostTwitterId");
    ...
    public final void O(final ypp ypp) {
        zzd.f((Object)ypp, "type");
        if (zzd.a((Object)ypp, (Object)ypp.q.b)) {
            this.N("send_tweet");
        }
        else if (zzd.a((Object)ypp, (Object)ypp.c.b)) {
            this.N("link");
        }
        else if (zzd.a((Object)ypp, (Object)ypp.v.b)) {
            this.N("rules");
        }
        else if (zzd.a((Object)ypp, (Object)ypp.w.b)) {
            this.N("view_transcriptions");
        }
        else if (zzd.a((Object)ypp, (Object)ypp.n.b)) {
            this.N("report");
        }
        else if (zzd.a((Object)ypp, (Object)ypp.o.b)) {
            this.N("send_dm");
        }
    }
    ...
    public final void Q(final ypp ypp) {
        zzd.f((Object)ypp, "type");
        if (zzd.a((Object)ypp, (Object)ypp.i.b)) {
        ...
        else if (zzd.a((Object)ypp, (Object)ypp.p.b)) {
            F(this, "caret", "feedback", "click", null, null, 24);
        }
        else if (zzd.a((Object)ypp, (Object)ypp.v.b)) {
            F(this, "caret", "rules", "click", null, null, 24);
        }
        else if (zzd.a((Object)ypp, (Object)ypp.a.b)) {
            ...
            if (!(ypp instanceof ypp.j)) {
                final boolean b = ypp instanceof ypp.k;
                return;
            }
            final w1a b2 = ((ypp.j)ypp).b;
            zzd.f((Object)b2, "emoji");
            G(this, "", "reaction_picker", this.z(b2), "click", null, 48);
        }
    }
    
    public final void R(final yvt yvt) {
        G(this, this.A(yvt), "", "", "impression", null, 48);
    }
    ...
    public final void Z(final String s, final int f, final String s2, final String s3, final String s4) {
        final lev lev = new lev();
        lev.a = Long.parseLong(s);
        lev.c = 36;
        lev.f = f;
        this.a0(s2, s3, s4, tdy.u0((Object)lev));
    }
    ...
    public final void a0(final String s, final String s2, final String s3, final List<? extends szo> list) {
    ...
    public final void c0(final Set<String> set) {
        ...
        final ArrayList list = new ArrayList<szo>(kr4.h1((Iterable)set, 10));
        ...
        this.a0(d, "topic", "impression", (List<? extends szo>)list);
    }
    ...
    public final String z(final w1a w1a) {
        String s = null;
        switch (w1a.ordinal()) {
            default: {
                throw new NoWhenBranchMatchedException();

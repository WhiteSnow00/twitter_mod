...
public final class ihy
{
    ...
    public ihy(final Context b, final dxy a) {
        final dhy c = new dhy(new h9y(a));
        this.a = a;
        this.b = b;
        this.c = c;
    }
    ...
    public final boolean a(final File[] array) throws IOException, XmlPullParserException {
        ...
        Label_0078:
            while (--length >= 0) {
                ...
                c2.b = assetManager.openXmlResourceParser(h9y.b(assetManager, file), "AndroidManifest.xml");
                final dhy c3 = this.c;
                if (c3.b != null) {
                    while (true) {
        ...
        Label_0162:
            while (true) {
                ...
                if (n >= 0) {
                    ...
                    try {
                        Object o = file.getAbsolutePath();
                        try {
                            final X509Certificate[][] t0 = chw.T0((String)o);
                            if (t0 != null && t0.length != 0 && t0[0].length != 0) {
                                ...
                                Label_0241:
                                    while (true) {
                                        ...
                                        if (((Iterator)o).hasNext()) {
                                            final X509Certificate x509Certificate2 = (X509Certificate)((Iterator)o).next();
                                            for (int length3 = t0.length, j = 0; j < length3; ++j) {
                                                if (t0[j][0].equals(x509Certificate2)) {
                                                    continue Label_0241;
                                                }
                                            }
                                            break;
                                ...
                                final StringBuilder sb = new StringBuilder(String.valueOf(o).length() + 32);
                            ...
                            final StringBuilder sb2 = new StringBuilder(String.valueOf(o).length() + 32);

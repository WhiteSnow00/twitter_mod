...
public final class anx
{
    ...
    public static void a(final String s, final b b, final List<a> list, final SpannableStringBuilder spannableStringBuilder, final List<xmx> list2) {
        final int b2 = b.b;
            ...
            switch (n) {
                ...
                case 6: {
                    ...
                    while (true) {
                        ...
                        final xmx d0 = list3.get(n2).D0;
                        if (d0 != null) {
                            if (d0.a() != -1) {
                                wvz.b((Spannable)spannableStringBuilder, (Object)new StyleSpan(d0.a()), b2, length);
                            }
                            if (d0.j == 1) {
                            ...
                            if (d0.g) {
                                ...
                                wvz.b((Spannable)spannableStringBuilder, (Object)new ForegroundColorSpan(d0.f), b2, length);
                            }
                            if (d0.i) {
                                if (!d0.i) {
                                    throw new IllegalStateException("Background color not defined.");
                                }
                                wvz.b((Spannable)spannableStringBuilder, (Object)new BackgroundColorSpan(d0.h), b2, length);
                            }
                            if (d0.e != null) {
                                wvz.b((Spannable)spannableStringBuilder, (Object)new TypefaceSpan(d0.e), b2, length);
                            }
                            final int n3 = d0.n;
                            if (n3 != 1) {
                                if (n3 != 2) {
                                    if (n3 == 3) {
                                        wvz.b((Spannable)spannableStringBuilder, (Object)new RelativeSizeSpan(d0.o / 100.0f), b2, length);
                                    }
                                }
                                else {
                                    wvz.b((Spannable)spannableStringBuilder, (Object)new RelativeSizeSpan(d0.o), b2, length);
                                }
                            }
                            else {
                                wvz.b((Spannable)spannableStringBuilder, (Object)new AbsoluteSizeSpan((int)d0.o, true), b2, length);
                            }
                            if (d0.q) {
                                spannableStringBuilder.setSpan((Object)new tqc(), b2, length, 33);
                            }
                        }
                        ++n2;
                    }
                ...
                case 7: {
                    ...
                    list4.addAll(list);
                    Collections.sort((List<Object>)list4, (Comparator<? super Object>)zmx.D0);
                    int b4 = b.b;
                    int i = 0;
                    int n4 = 0;
                    while (i < list4.size()) {
                        if ("rt".equals(((a)list4.get(i)).a.a)) {
                            ...
                            spannableStringBuilder.setSpan((Object)new qlo(subSequence.toString(), c2), b4, n5, 33);
                ...
                case 2: {
                    for (final String s2 : b.d) {
                        final Map<String, Integer> c3 = anx.c;
                        if (c3.containsKey(s2)) {
                            spannableStringBuilder.setSpan((Object)new ForegroundColorSpan((int)c3.get(s2)), b2, length, 33);
                        }
                        else {
                            final Map<String, Integer> d2 = anx.d;
                            if (!d2.containsKey(s2)) {
                                continue;
                            }
                            spannableStringBuilder.setSpan((Object)new BackgroundColorSpan((int)d2.get(s2)), b2, length, 33);
                        }
                    }
                    continue;
                }
    ...
    public static List<c> b(final List<xmx> list, final String s, final b b) {
        final ArrayList list2 = new ArrayList();
        for (int i = 0; i < list.size(); ++i) {
            final xmx xmx = list.get(i);
            final String a = b.a;
            final Set<String> d = b.d;
            final String c = b.c;
            int empty;
            if (xmx.a.isEmpty() && xmx.b.isEmpty() && xmx.c.isEmpty() && xmx.d.isEmpty()) {
                empty = (TextUtils.isEmpty((CharSequence)a) ? 1 : 0);
            }
            else {
                final int b2 = xmx.b(xmx.b(xmx.b(0, xmx.a, s, 1073741824), xmx.b, a, 2), xmx.d, c, 4);
                if (b2 != -1 && d.containsAll(xmx.c)) {
                    empty = b2 + xmx.c.size() * 4;
                }
                else {
                    empty = 0;
                }
    ...
    public static int c(final List<xmx> list, final String s, final b b) {
    ...
    public static ymx d(String s, Matcher matcher, final mwj mwj, final List<xmx> list) {
        final d d = new d();
        try {
            ...
            for (matcher = (Matcher)mwj.f(); !TextUtils.isEmpty((CharSequence)matcher); matcher = (Matcher)mwj.f()) {
                if (sb.length() > 0) {
                    sb.append("\n");
                }
    ...
    public static void e(String s, final d d) {
        final Matcher matcher = anx.b.matcher(s);
    Label_0363_Outer:
        while (matcher.find()) {
            int k = 1;
            int d2 = 1;
                ...
                if ("line".equals(group)) {
                    ...
                    while (true) {
                        switch (n) {
                            ...
                            default: {
                                if (group2.length() != 0) {
                                    s = "Invalid alignment value: ".concat(group2);
                                }
                                else {
                    ...
                    if (!group2.equals("lr")) {
                        if (!group2.equals("rl")) {
                            if (group2.length() != 0) {
                                s = "Invalid 'vertical' value: ".concat(group2);
                            }
                            else {
                    ...
                    final StringBuilder sb = new StringBuilder(group.length() + 21 + group2.length());
    ...
    public static SpannedString f(final String s, final String s2, final List<xmx> list) {
    ...
    public static final class c implements Comparable<c>
    {
        ...
        public c(final int c0, final xmx d0) {
            this.C0 = c0;
            this.D0 = d0;
        }
        ...
        public final int compareTo(final Object o) {
            return Integer.compare(this.C0, ((c)o).C0);
        }
    }
                    ...
                    if (d3 != 1) {
                        if (d3 != 2) {
                            if (d3 != 3) {
                                ...
                                if (d3 != 5) {
                                    zi.z(34, "Unknown textAlignment: ", d3, "WebvttCueParser");
                                    c = null;
                                    break Label_0180;
                                }
                            }

...
public final class qes
{
    ...
    public qes(final Context context, final int n) {
        this.m = false;
        final TypedArray obtainStyledAttributes = context.obtainStyledAttributes(n, wiy.z1);
        this.k = obtainStyledAttributes.getDimension(0, 0.0f);
        this.j = nng.b(context, obtainStyledAttributes, 3);
        nng.b(context, obtainStyledAttributes, 4);
        nng.b(context, obtainStyledAttributes, 5);
        ...
        this.a = nng.b(context, obtainStyledAttributes, 6);
        ...
        final TypedArray obtainStyledAttributes2 = context.obtainStyledAttributes(n, wiy.n1);
    ...
    public final Typeface b(final Context context) {
        ...
        try {
            final Typeface b = orm.b(context, this.l);
            this.n = b;
            if (b != null) {
                this.n = Typeface.create(b, this.c);
                goto Label_0079;
            ...
            final StringBuilder j = fu8.j("Error loading font ");
            j.append(this.b);
            Log.d("TextAppearance", j.toString(), (Throwable)ex);
        }
    ...
    public final void c(final Context context, final h6r h6r) {
        if (this.d(context)) {
            this.b(context);
        }
        else {
        ...
        try {
            final qes$a qes$a = new qes$a(this, h6r);
            final ThreadLocal a = orm.a;
            if (context.isRestricted()) {
                ((orm$e)qes$a).a(-4);
            }
            else {
                orm.c(context, l, new TypedValue(), 0, (orm$e)qes$a, false, false);
            }
        }
        catch (final Exception ex) {
            final StringBuilder j = fu8.j("Error loading font ");
    ...
    public final boolean d(final Context context) {
        ...
        if (l != 0) {
            final ThreadLocal a = orm.a;
            if (!context.isRestricted()) {
                final Typeface c = orm.c(context, l, new TypedValue(), 0, (orm$e)null, false, true);
                return c != null;
            }
        }
    ...
    public final void e(final Context context, final TextPaint textPaint, final h6r h6r) {
        this.f(context, textPaint, h6r);
    ...
    public final void f(final Context context, final TextPaint textPaint, final h6r h6r) {
        if (this.d(context)) {
            ...
            this.c(context, (h6r)new res(this, context, textPaint, h6r));
        }
    }
    
    public final void g(final Context context, final TextPaint textPaint, Typeface typeface) {
        final Typeface a = ymv.a(context.getResources().getConfiguration(), typeface);
        if (a != null) {
            typeface = a;
        }

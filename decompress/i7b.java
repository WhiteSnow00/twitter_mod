...
public final class i7b implements Comparable<i7b>
{
    ...
    static {
        ...
        b(1.0f);
        b(-1.0f);
        C0 = Float.intBitsToFloat(1056964608);
    }
    
    public static short b(final float n) {
        Objects.requireNonNull(i7b.Companion);
    ...
    public static final float e(final short n) {
        ...
        if (n4 == 0) {
            if (n5 != 0) {
                float n7 = Float.intBitsToFloat(n5 + 1056964608) - i7b.C0;
                if (n3 != 0) {
                    n7 = -n7;
                }
                return n7;

...
public final class fcx implements ecx
{
    ...
    static {
        fcx.f = (ced)ced.i((Object[])new Integer[] { 0, 25, 50, 75, 80, 100 });
    }
    
    public fcx(final jth a, final boolean b) {
        this.a = a;
        this.b = b;
        this.c = (tth$a)tth.a(21);
        this.d = (tth$a)tth.a(21);
        ...
        if (this.b) {
            ...
            while (i >= 0) {
                ...
                if (i <= intValue) {
                    ...
                    intValue2 = intValue;
                    if ((n2 = n) >= 0) {
                        intValue2 = ((List<Integer>)fcx.f).get(n);
                        n2 = n;
                    }
                }
                i -= 5;

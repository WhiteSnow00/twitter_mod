...
public final class uko extends Drawable
{
    public float a;
    ...
    public uko(final ColorStateList list, final float a) {
        this.f = false;
        this.g = true;
    ...
    public final void c(final Rect rect) {
        ...
        this.d.set(bounds);
        if (this.f) {
            this.d.inset((int)Math.ceil(vko.a(this.e, this.a, this.g)), (int)Math.ceil(vko.b(this.e, this.a, this.g)));
            this.c.set(this.d);
        }
    }

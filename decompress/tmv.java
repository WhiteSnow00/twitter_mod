...
public class tmv extends anv
{
    ...
    public static boolean g(final Object ex, final String s, final int n, final boolean b) {
        h();
        try {
            return (boolean)tmv.d.invoke(ex, s, n, b);
        }
    ...
    public Typeface a(Context instance, jlb$c d, final Resources resources, int i) {
        h();
        try {
            final Object instance2 = tmv.c.newInstance(new Object[0]);
            final jlb.d[] a = d.a;
            final int length = a.length;
            i = 0;
            while (i < length) {
                final jlb.d d2 = a[i];
                d = (jlb$c)bnv.d((Context)instance);
                if (d == null) {
                    return null;
                }
                try {
                    if (!bnv.b((File)d, resources, d2.f)) {
                        return null;
                    }
                    if (!g(instance2, ((File)d).getPath(), d2.b, d2.c)) {
                        return null;
                    }
                    ((File)d).delete();
                    ++i;
            ...
            h();
            try {
                instance = (RuntimeException)Array.newInstance(tmv.b, 1);
                Array.set(instance, 0, instance2);
                instance = (RuntimeException)tmv.e.invoke(null, instance);
    ...
    public Typeface b(final Context p0, final slb[] p1, final int p2) {
        // 
        ...
        //     9: aload_2        
        //    10: iload_3        
        //    11: invokevirtual   anv.f:([Lslb;I)Lslb;
        //    14: astore_2       
        //    15: aload_1        
        ...
        //    21: aload           4
        //    23: aload_2        
        //    24: getfield        slb.a:Landroid/net/Uri;
        //    27: ldc             "r"
        //    29: aconst_null    
        ...
        //   159: aload_1        
        //   160: aload_2        
        //   161: invokevirtual   anv.c:(Landroid/content/Context;Ljava/io/InputStream;)Landroid/graphics/Typeface;
        //   164: astore_1       
        //   165: aload_2        

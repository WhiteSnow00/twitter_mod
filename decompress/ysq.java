...
public interface ysq
{
    boolean A();
    
    void a(final String p0, final boolean p1);
    
    void b(final StationFeed p0, final owt p1, final StationTrack$TrackData p2);
    ...
    void l(final String p0, final z21 p1, final ica p2, final boolean p3, final boolean p4);
    ...
    void p(final String p0, final boolean p1, final ica p2, final boolean p3, final boolean p4);
    ...
    void t(final String p0, final boolean p1, final ica p2);
    
    void u(final String p0);
    
    public interface a
    {
        ysq a(final zl1 p0, final kcm p1);
    }
}

...
public abstract class z78<T extends z7a> extends ok1<T>
{
    public List<T> m;
    public float n;
    public float o;
    ...
    public z78(final List<T> p0, final String p1) {
        // 
        // This method could not be decompiled.
        // 
        // Original Bytecode:
        // 
        //     1: invokespecial   ok1.<init>:()V
        //     4: aload_0        
        //     5: ldc             -3.4028235E38
        //     7: putfield        z78.n:F
        //    10: aload_0        
        ...
        //    28: aload_0        
        //    29: aload_1        
        //    30: putfield        z78.m:Ljava/util/List;
        //    33: aload_1        
        //    34: ifnonnull       48
        //    37: aload_0        
        ...
        //    45: putfield        z78.m:Ljava/util/List;
        //    48: aload_0        
        //    49: getfield        z78.m:Ljava/util/List;
        //    52: astore_1       
        //    53: aload_1        
        //    54: ifnull          128
        //    57: aload_1        
        ...
        //    90: putfield        z78.q:F
        //    93: aload_0        
        //    94: getfield        z78.m:Ljava/util/List;
        ...
        //   119: checkcast       Lz7a;
        //   122: invokevirtual   z78.g0:(Lz7a;)V
        //   125: goto            103
        //   128: return         
        //    Signature:
    ...
    public final T I(final float n, final float n2) {
        return this.R(n, n2, z78.z78$a.E0);
    }
    
    public final T R(final float n, final float n2, final z78.z78$a z78$a) {
        final int i0 = this.i0(n, n2, z78$a);
        if (i0 > -1) {
    ...
    public final int i(final z7a z7a) {
        return this.m.indexOf(z7a);
    }
    
    public final int i0(float a, final float n, final z78.z78$a z78$a) {
                ...
                Label_0414:
                    while (true) {
                        ...
                        do {
                            ...
                            n9 = n10;
                        } while (Math.abs(z7a.a() - n) >= Math.abs(a - n));
                        a = n;
                        k = n10;
                    }
                    n7 = k;
    ...
    public final String toString() {
        ...
        final StringBuilder g = w48.g("DataSet, label: ");
        String c;
        if ((c = super.c) == null) {
            c = "";
        }
    ...
    public final void u(final float n, final float n2) {
        ...
        if (m != null) {
            if (!m.isEmpty()) {
                ...
                for (int i = this.i0(n, Float.NaN, z78.z78$a.D0); i <= this.i0(n2, Float.NaN, z78.z78$a.C0); ++i) {
    ...
    public final List<T> v(final float n) {
        ...
        while (i <= n2) {
            final int n3 = (n2 + i) / 2;
            final z7a z7a = this.m.get(n3);
            if (n == z7a.b()) {
                int j;
                for (j = n3; j > 0 && this.m.get(j - 1).b() == n; --j) {}
                while (j < this.m.size()) {
                    final z7a z7a2 = this.m.get(j);
                    if (z7a2.b() != n) {
                        break;
                    }
                    list.add(z7a2);

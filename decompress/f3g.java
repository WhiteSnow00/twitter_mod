...
public final class f3g
{
    ...
    public final f3g$a e;
    
    static {
        f = new Object();
    }
    
    public f3g(final Context a) {
    ...
    public static f3g a(final Context context) {
        synchronized (f3g.f) {
            if (f3g.g == null) {
                f3g.g = new f3g(context.getApplicationContext());
            }
            return f3g.g;
        }
    }

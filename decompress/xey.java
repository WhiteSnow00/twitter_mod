...
public abstract class xey<E> extends ndy<E> implements List<E>, RandomAccess
{
    public static final egy<Object> G0;
    
    static {
        xey.G0 = new gey(lfy.J0, 0);
    }
    ...
    public xey<E> k(final int n, int n2) {
        bs4.B0(n, n2, ((AbstractCollection)this).size());
        n2 -= n;
    ...
    public final egy<E> m(final int n) {
        final int size = ((AbstractCollection)this).size();
        if (n < 0 || n > size) {
            throw new IndexOutOfBoundsException(bs4.C0(n, size, "index"));
        }
        if (((AbstractCollection)this).isEmpty()) {
            return xey.G0;
        }
        return (egy<E>)new gey((xey<Object>)this, n);
    }

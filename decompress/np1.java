...
public class np1 implements ypm
{
    @Override
    public void a(final a a, final Object o, final String s, final boolean b) {
    }
    ...
    @Override
    public void c(final a a, final String s, final boolean b) {
    }
    ...
    public final void g(final String p0, final String p1, final Map<String, String> p2) {
        // 
    ...
    public void h(final String s, final String s2, final boolean b) {
    }
    ...
    @Override
    public void j(final a a, final String s, final Throwable t, final boolean b) {
    }

...
public final class InboxItemCompose extends p9v
{
    ...
    public InboxItemCompose(final Context context, final AttributeSet set) {
        ...
        this.O0 = (cwj)nkz.r((Object)pid.C0);
        this.P0 = (cwj)nkz.r((Object)qid.C0);
        this.Q0 = (cwj)nkz.r((Object)rid.C0);
    }
    
    public final otb<oyv> getAvatarClickListener$feature_tfa_dm_api_legacy_release() {
        return (otb<oyv>)((nhq)this.O0).getValue();
    }
    ...
    public final void j(m76 h, final int n) {
        ...
        if ((n3 & 0xB) == 0x2 && h.i()) {
            ...
            if (dmInboxItem$feature_tfa_dm_api_legacy_release == null) {
                ...
                if (k != null) {
                    k.a((gub)new gub<m76, Integer, oyv>() {
                        public final /* synthetic */ InboxItemCompose C0;
            ...
            sid.a(dmInboxItem$feature_tfa_dm_api_legacy_release, conversationTitle$feature_tfa_dm_api_legacy_release, intValue, this.getCellContentDescription$feature_tfa_dm_api_legacy_release(), previewText$feature_tfa_dm_api_legacy_release, (otb)this.getAvatarClickListener$feature_tfa_dm_api_legacy_release(), (otb)this.getContentClickListener$feature_tfa_dm_api_legacy_release(), (otb)this.getContentLongClickListener$feature_tfa_dm_api_legacy_release(), (jkh)null, h, 32776, 256);
        }
        final vwo m = h.k();
        if (m != null) {

...
public final class EditVerifiedPhoneContentViewResult implements bn6
{
    ...
    public EditVerifiedPhoneContentViewResult(final int n, final boolean optedIn, final hlp hlp) {
        if (0x1 == (n & 0x1)) {
            this.optedIn = optedIn;
            return;
        }
        blz.a0(n, 1, EditVerifiedPhoneContentViewResult$$serializer.INSTANCE.getDescriptor());
        throw null;
    }
    ...
    public static final void write$Self(final EditVerifiedPhoneContentViewResult editVerifiedPhoneContentViewResult, final xc6 xc6, final SerialDescriptor serialDescriptor) {
        czd.f((Object)editVerifiedPhoneContentViewResult, "self");
        czd.f((Object)xc6, "output");
        czd.f((Object)serialDescriptor, "serialDesc");
        xc6.R(serialDescriptor, 0, editVerifiedPhoneContentViewResult.optedIn);
    }
    ...
    public String toString() {
        return ib0.C("EditVerifiedPhoneContentViewResult(optedIn=", this.optedIn, ")");
    }
    
    @Metadata(bv = {}, d1 = { "\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0086\u0003\u0018\u00002\u00020\u0001J\u000f\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00030\u0002H\u00c6\u0001¨\u0006\u0005" }, d2 = { "Lcom/twitter/app/profiles/api/EditVerifiedPhoneContentViewResult$Companion;", "", "Lkotlinx/serialization/KSerializer;", "Lcom/twitter/app/profiles/api/EditVerifiedPhoneContentViewResult;", "serializer", "feature.tfa.profiles.api_release" }, k = 1, mv = { 1, 7, 1 })
    public static final class Companion
    {
        public final KSerializer<EditVerifiedPhoneContentViewResult> serializer() {
            return (KSerializer<EditVerifiedPhoneContentViewResult>)EditVerifiedPhoneContentViewResult$$serializer.INSTANCE;
        }
    }
}

...
{
    public static final EditVerifiedPhoneArgs.EditVerifiedPhoneArgs$Companion Companion;
    private final boolean optedIn;
    
    static {
        Companion = new EditVerifiedPhoneArgs.EditVerifiedPhoneArgs$Companion();
    }
    
    public EditVerifiedPhoneArgs(final int n, final boolean optedIn, final dmp dmp) {
        if (0x1 == (n & 0x1)) {
            this.optedIn = optedIn;
            return;
        }
        shw.V0(n, 1, EditVerifiedPhoneArgs$$serializer.INSTANCE.getDescriptor());
        throw null;
    }
    ...
    public static final void write$Self(final EditVerifiedPhoneArgs editVerifiedPhoneArgs, final ee6 ee6, final SerialDescriptor serialDescriptor) {
        e0e.f((Object)editVerifiedPhoneArgs, "self");
        e0e.f((Object)ee6, "output");
        e0e.f((Object)serialDescriptor, "serialDesc");
        ee6.R(serialDescriptor, 0, editVerifiedPhoneArgs.optedIn);
    }
    ...
    public String toString() {
        return jba.o("EditVerifiedPhoneArgs(optedIn=", this.optedIn, ")");
    }
}

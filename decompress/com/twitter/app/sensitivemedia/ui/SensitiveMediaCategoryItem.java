...
@Metadata(bv = {}, d1 = { "\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0005\u0018\u00002\u00020\u0001R\u001b\u0010\u0007\u001a\u00020\u00028BX\u0082\u0084\u0002¢\u0006\f\n\u0004\b\u0003\u0010\u0004\u001a\u0004\b\u0005\u0010\u0006R\u001b\u0010\f\u001a\u00020\b8BX\u0082\u0084\u0002¢\u0006\f\n\u0004\b\t\u0010\u0004\u001a\u0004\b\n\u0010\u000b¨\u0006\r" }, d2 = { "Lcom/twitter/app/sensitivemedia/ui/SensitiveMediaCategoryItem;", "Landroid/widget/FrameLayout;", "Lcom/twitter/ui/components/text/legacy/TypefacesTextView;", "titleView$delegate", "Lgxe;", "getTitleView", "()Lcom/twitter/ui/components/text/legacy/TypefacesTextView;", "titleView", "Landroid/widget/CheckBox;", "checkboxView$delegate", "getCheckboxView", "()Landroid/widget/CheckBox;", "checkboxView", "feature.tfa.sensitivemedia.api-legacy_release" }, k = 1, mv = { 1, 7, 1 })
public final class SensitiveMediaCategoryItem extends FrameLayout
{
    ...
    public SensitiveMediaCategoryItem(final Context context, final AttributeSet set) {
        ...
        super(context, set, 0);
        this.C0 = (u3s)rp2.z0((otb)new lhp(this));
        this.D0 = (u3s)rp2.z0((otb)new khp(this));
        ((View)this).setMinimumHeight(context.getResources().getDimensionPixelSize(2131167443));
        LayoutInflater.from(context).inflate(2131625648, (ViewGroup)this);
        final TypedArray obtainStyledAttributes = context.obtainStyledAttributes(set, tdy.c1, 0, 0);
        zzd.e((Object)obtainStyledAttributes, "context.obtainStyledAttr\u2026oryItem, defStyleAttr, 0)");

...
@bmp
@Metadata(bv = {}, d1 = { "\u0000@\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0005\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u0000\n\u0002\b\b\n\u0002\u0018\u0002\n\u0002\b\u0005\b\u0087\b\u0018\u0000 \u001f2\u00020\u0001:\u0002 \u001fB\u001b\u0012\b\b\u0002\u0010\f\u001a\u00020\t\u0012\b\b\u0002\u0010\r\u001a\u00020\t¢\u0006\u0004\b\u0019\u0010\u001aB+\b\u0017\u0012\u0006\u0010\u001b\u001a\u00020\u0011\u0012\u0006\u0010\f\u001a\u00020\t\u0012\u0006\u0010\r\u001a\u00020\t\u0012\b\u0010\u001d\u001a\u0004\u0018\u00010\u001c¢\u0006\u0004\b\u0019\u0010\u001eJ!\u0010\b\u001a\u00020\u00072\u0006\u0010\u0002\u001a\u00020\u00002\u0006\u0010\u0004\u001a\u00020\u00032\u0006\u0010\u0006\u001a\u00020\u0005H\u00c7\u0001J\t\u0010\n\u001a\u00020\tH\u00c6\u0003J\t\u0010\u000b\u001a\u00020\tH\u00c6\u0003J\u001d\u0010\u000e\u001a\u00020\u00002\b\b\u0002\u0010\f\u001a\u00020\t2\b\b\u0002\u0010\r\u001a\u00020\tH\u00c6\u0001J\t\u0010\u0010\u001a\u00020\u000fH\u00d6\u0001J\t\u0010\u0012\u001a\u00020\u0011H\u00d6\u0001J\u0013\u0010\u0015\u001a\u00020\t2\b\u0010\u0014\u001a\u0004\u0018\u00010\u0013H\u00d6\u0003R\u0017\u0010\f\u001a\u00020\t8\u0006¢\u0006\f\n\u0004\b\f\u0010\u0016\u001a\u0004\b\u0017\u0010\u0018R\u0017\u0010\r\u001a\u00020\t8\u0006¢\u0006\f\n\u0004\b\r\u0010\u0016\u001a\u0004\b\r\u0010\u0018¨\u0006!" }, d2 = { "Lcom/twitter/business/features/linkmodule/api/LinkConfigurationContentViewResult;", "Lho6;", "self", "Lee6;", "output", "Lkotlinx/serialization/descriptors/SerialDescriptor;", "serialDesc", "Lvzv;", "write$Self", "", "component1", "component2", "modulesWereUpdated", "isFeatured", "copy", "", "toString", "", "hashCode", "", "other", "equals", "Z", "getModulesWereUpdated", "()Z", "<init>", "(ZZ)V", "seen1", "Ldmp;", "serializationConstructorMarker", "(IZZLdmp;)V", "Companion", "$serializer", "subsystem.tfa.business.features.link-module.api_release" }, k = 1, mv = { 1, 7, 1 })
public final class LinkConfigurationContentViewResult implements ho6
{
    ...
    public LinkConfigurationContentViewResult(final int n, final boolean modulesWereUpdated, final boolean isFeatured, final dmp dmp) {
        if ((n & 0x0) == 0x0) {
            if ((n & 0x1) == 0x0) {
    ...
    public LinkConfigurationContentViewResult(boolean b, boolean b2, final int n, final wg8 wg8) {
        if ((n & 0x1) != 0x0) {
            b = false;
        }
        if ((n & 0x2) != 0x0) {
    ...
    public static final void write$Self(final LinkConfigurationContentViewResult linkConfigurationContentViewResult, final ee6 ee6, final SerialDescriptor serialDescriptor) {
        e0e.f((Object)linkConfigurationContentViewResult, "self");
        ...
        if (b) {
            ee6.R(serialDescriptor, 0, linkConfigurationContentViewResult.modulesWereUpdated);
        }
        int n2 = 0;
        Label_0093: {
        ...
        if (n2 != 0) {
            ee6.R(serialDescriptor, 1, linkConfigurationContentViewResult.isFeatured);
        }
    }
    ...
    public String toString() {
        return p4l.f("LinkConfigurationContentViewResult(modulesWereUpdated=", this.modulesWereUpdated, ", isFeatured=", this.isFeatured, ")");
    }
    
    @Metadata(bv = {}, d1 = { "\u00004\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0011\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0006\b\u00c7\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0013\u0010\u0014J\u001a\u0010\u0005\u001a\f\u0012\b\u0012\u0006\u0012\u0002\b\u00030\u00040\u0003H\u00d6\u0001¢\u0006\u0004\b\u0005\u0010\u0006J\u0011\u0010\t\u001a\u00020\u00022\u0006\u0010\b\u001a\u00020\u0007H\u00d6\u0001J\u0019\u0010\u000e\u001a\u00020\r2\u0006\u0010\u000b\u001a\u00020\n2\u0006\u0010\f\u001a\u00020\u0002H\u00d6\u0001R\u0014\u0010\u0012\u001a\u00020\u000f8VX\u00d6\u0005¢\u0006\u0006\u001a\u0004\b\u0010\u0010\u0011¨\u0006\u0015" }, d2 = { "com/twitter/business/features/linkmodule/api/LinkConfigurationContentViewResult.$serializer", "Lezb;", "Lcom/twitter/business/features/linkmodule/api/LinkConfigurationContentViewResult;", "", "Lkotlinx/serialization/KSerializer;", "childSerializers", "()[Lkotlinx/serialization/KSerializer;", "Lkotlinx/serialization/encoding/Decoder;", "decoder", "deserialize", "Lkotlinx/serialization/encoding/Encoder;", "encoder", "value", "Lvzv;", "serialize", "Lkotlinx/serialization/descriptors/SerialDescriptor;", "getDescriptor", "()Lkotlinx/serialization/descriptors/SerialDescriptor;", "descriptor", "<init>", "()V", "subsystem.tfa.business.features.link-module.api_release" }, k = 1, mv = { 1, 7, 1 })
    public static final class $serializer implements ezb<LinkConfigurationContentViewResult>
    {
        public static final $serializer INSTANCE;
        public static final SerialDescriptor descriptor;
        
        static {
            final fpk descriptor2 = new fpk("com.twitter.business.features.linkmodule.api.LinkConfigurationContentViewResult", (ezb)(INSTANCE = new $serializer()), 2);
        ...
        public LinkConfigurationContentViewResult deserialize(final Decoder decoder) {
            ...
            c.d(descriptor);
            return new LinkConfigurationContentViewResult(n, b2, b, null);
        }
        ...
        public void serialize(final Encoder encoder, final LinkConfigurationContentViewResult linkConfigurationContentViewResult) {
            e0e.f((Object)encoder, "encoder");
            e0e.f((Object)linkConfigurationContentViewResult, "value");
            final SerialDescriptor descriptor = this.getDescriptor();
            final ee6 c = encoder.c(descriptor);
            LinkConfigurationContentViewResult.write$Self(linkConfigurationContentViewResult, c, descriptor);
            c.d(descriptor);
        }
        
        public /* bridge */ void serialize(final Encoder encoder, final Object o) {
            this.serialize(encoder, (LinkConfigurationContentViewResult)o);
        }

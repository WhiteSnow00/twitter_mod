...
@flp
@Metadata(bv = {}, d1 = { "\u0000@\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0005\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u0000\n\u0002\b\b\n\u0002\u0018\u0002\n\u0002\b\u0005\b\u0087\b\u0018\u0000 \u001f2\u00020\u0001:\u0002 \u001fB\u001b\u0012\b\b\u0002\u0010\f\u001a\u00020\t\u0012\b\b\u0002\u0010\r\u001a\u00020\t¢\u0006\u0004\b\u0019\u0010\u001aB+\b\u0017\u0012\u0006\u0010\u001b\u001a\u00020\u0011\u0012\u0006\u0010\f\u001a\u00020\t\u0012\u0006\u0010\r\u001a\u00020\t\u0012\b\u0010\u001d\u001a\u0004\u0018\u00010\u001c¢\u0006\u0004\b\u0019\u0010\u001eJ!\u0010\b\u001a\u00020\u00072\u0006\u0010\u0002\u001a\u00020\u00002\u0006\u0010\u0004\u001a\u00020\u00032\u0006\u0010\u0006\u001a\u00020\u0005H\u00c7\u0001J\t\u0010\n\u001a\u00020\tH\u00c6\u0003J\t\u0010\u000b\u001a\u00020\tH\u00c6\u0003J\u001d\u0010\u000e\u001a\u00020\u00002\b\b\u0002\u0010\f\u001a\u00020\t2\b\b\u0002\u0010\r\u001a\u00020\tH\u00c6\u0001J\t\u0010\u0010\u001a\u00020\u000fH\u00d6\u0001J\t\u0010\u0012\u001a\u00020\u0011H\u00d6\u0001J\u0013\u0010\u0015\u001a\u00020\t2\b\u0010\u0014\u001a\u0004\u0018\u00010\u0013H\u00d6\u0003R\u0017\u0010\f\u001a\u00020\t8\u0006¢\u0006\f\n\u0004\b\f\u0010\u0016\u001a\u0004\b\u0017\u0010\u0018R\u0017\u0010\r\u001a\u00020\t8\u0006¢\u0006\f\n\u0004\b\r\u0010\u0016\u001a\u0004\b\r\u0010\u0018¨\u0006!" }, d2 = { "Lcom/twitter/business/api/BusinessInfoContentViewResult;", "Lbn6;", "self", "Lxc6;", "output", "Lkotlinx/serialization/descriptors/SerialDescriptor;", "serialDesc", "Lfzv;", "write$Self", "", "component1", "component2", "modulesWereUpdated", "isFeatured", "copy", "", "toString", "", "hashCode", "", "other", "equals", "Z", "getModulesWereUpdated", "()Z", "<init>", "(ZZ)V", "seen1", "Lhlp;", "serializationConstructorMarker", "(IZZLhlp;)V", "Companion", "$serializer", "subsystem.tfa.business.api_release" }, k = 1, mv = { 1, 7, 1 })
public final class BusinessInfoContentViewResult implements bn6
{
    ...
    public BusinessInfoContentViewResult(final int n, final boolean modulesWereUpdated, final boolean isFeatured, final hlp hlp) {
        if ((n & 0x0) == 0x0) {
            if ((n & 0x1) == 0x0) {
        ...
        blz.a0(n, 0, BusinessInfoContentViewResult$$serializer.INSTANCE.getDescriptor());
        throw null;
    }
    ...
    public BusinessInfoContentViewResult(boolean b, boolean b2, final int n, final rf8 rf8) {
        if ((n & 0x1) != 0x0) {
            b = false;
        }
        if ((n & 0x2) != 0x0) {
    ...
    public static final void write$Self(final BusinessInfoContentViewResult businessInfoContentViewResult, final xc6 xc6, final SerialDescriptor serialDescriptor) {
        czd.f((Object)businessInfoContentViewResult, "self");
        ...
        if (b) {
            xc6.R(serialDescriptor, 0, businessInfoContentViewResult.modulesWereUpdated);
        }
        int n2 = 0;
        Label_0093: {
        ...
        if (n2 != 0) {
            xc6.R(serialDescriptor, 1, businessInfoContentViewResult.isFeatured);
        }
    }
    ...
    public String toString() {
        return da8.k("BusinessInfoContentViewResult(modulesWereUpdated=", this.modulesWereUpdated, ", isFeatured=", this.isFeatured, ")");
    }
}

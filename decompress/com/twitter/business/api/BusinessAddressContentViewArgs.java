...
public final class BusinessAddressContentViewArgs implements ContentViewArgs
{
    ...
    public BusinessAddressContentViewArgs(final int n, final BusinessAddressInfoData addressData, final dmp dmp) {
        if ((n & 0x0) == 0x0) {
            if ((n & 0x1) == 0x0) {
                this.addressData = new BusinessAddressInfoData((String)null, (String)null, (String)null, (String)null, (CountryIso)null, 31, (wg8)null);
            }
            else {
        ...
        shw.V0(n, 0, BusinessAddressContentViewArgs$$serializer.INSTANCE.getDescriptor());
        throw null;
    }
    
    public BusinessAddressContentViewArgs(final BusinessAddressInfoData addressData) {
        e0e.f((Object)addressData, "addressData");
        this.addressData = addressData;
    }
    
    public BusinessAddressContentViewArgs(BusinessAddressInfoData businessAddressInfoData, final int n, final wg8 wg8) {
        if ((n & 0x1) != 0x0) {
            businessAddressInfoData = new BusinessAddressInfoData((String)null, (String)null, (String)null, (String)null, (CountryIso)null, 31, (wg8)null);
        }
    ...
    public static final void write$Self(final BusinessAddressContentViewArgs businessAddressContentViewArgs, final ee6 ee6, final SerialDescriptor serialDescriptor) {
        e0e.f((Object)businessAddressContentViewArgs, "self");
        e0e.f((Object)ee6, "output");
        e0e.f((Object)serialDescriptor, "serialDesc");
        boolean b = false;
        Label_0063: {
            if (!ee6.z(serialDescriptor)) {
                if (e0e.a((Object)businessAddressContentViewArgs.addressData, (Object)new BusinessAddressInfoData((String)null, (String)null, (String)null, (String)null, (CountryIso)null, 31, (wg8)null))) {
                    b = false;
                    break Label_0063;
                }
            }
        ...
        if (b) {
            ee6.T(serialDescriptor, 0, (fmp)BusinessAddressInfoData.$serializer.INSTANCE, (Object)businessAddressContentViewArgs.addressData);
        }
    }
    ...
    public final BusinessAddressContentViewArgs copy(final BusinessAddressInfoData businessAddressInfoData) {
        e0e.f((Object)businessAddressInfoData, "addressData");
        return new BusinessAddressContentViewArgs(businessAddressInfoData);
    }
    
    @Override
    public boolean equals(final Object o) {
        return this == o || (o instanceof BusinessAddressContentViewArgs && e0e.a((Object)this.addressData, (Object)((BusinessAddressContentViewArgs)o).addressData));
    }

...
public final class LeaveConversationPromptArgs implements ContentViewArgs
{
    ...
    static {
        Companion = new LeaveConversationPromptArgs.LeaveConversationPromptArgs$Companion();
    }
    ...
    public LeaveConversationPromptArgs(final int n, boolean educationOnly, final Long tweetId, final String scribePage, final String scribeSection, final dmp dmp) {
        if ((n & 0x0) == 0x0) {
            if ((n & 0x1) == 0x0) {
                educationOnly = true;
            }
        ...
        shw.V0(n, 0, LeaveConversationPrompt.LeaveConversationPromptArgs$$serializer.INSTANCE.getDescriptor());
        throw null;
    }
    ...
    public LeaveConversationPromptArgs(final boolean educationOnly, final Long tweetId, final String scribePage, final String scribeSection) {
        e0e.f((Object)scribePage, "scribePage");
        e0e.f((Object)scribeSection, "scribeSection");
        this.educationOnly = educationOnly;
        this.tweetId = tweetId;
        this.scribePage = scribePage;
        this.scribeSection = scribeSection;
    ...
    public LeaveConversationPromptArgs(boolean b, Long n, String s, String s2, final int n2, final wg8 wg8) {
        if ((n2 & 0x1) != 0x0) {
            b = true;
        }
        if ((n2 & 0x2) != 0x0) {
    ...
    public static final void write$Self(final LeaveConversationPromptArgs leaveConversationPromptArgs, final ee6 ee6, final SerialDescriptor serialDescriptor) {
        e0e.f((Object)leaveConversationPromptArgs, "self");
        ...
        if (b) {
            ee6.R(serialDescriptor, 0, leaveConversationPromptArgs.educationOnly);
        }
        boolean b2 = false;
        Label_0096: {
        ...
        if (b2) {
            ee6.y(serialDescriptor, 1, (fmp)wcg.a, (Object)leaveConversationPromptArgs.tweetId);
        }
        boolean b3 = false;
        Label_0147: {
            if (!ee6.z(serialDescriptor)) {
                if (e0e.a((Object)leaveConversationPromptArgs.scribePage, (Object)"")) {
                    b3 = false;
                    break Label_0147;
                }
            }
        ...
        if (b3) {
            ee6.S(serialDescriptor, 2, leaveConversationPromptArgs.scribePage);
        }
        int n2 = 0;
        Label_0193: {
            if (!ee6.z(serialDescriptor)) {
                n2 = n;
                if (e0e.a((Object)leaveConversationPromptArgs.scribeSection, (Object)"")) {
                    break Label_0193;
                }
            }
            n2 = 1;
        ...
        if (n2 != 0) {
            ee6.S(serialDescriptor, 3, leaveConversationPromptArgs.scribeSection);
        }
    }
    ...
    public final LeaveConversationPromptArgs copy(final boolean b, final Long n, final String s, final String s2) {
        e0e.f((Object)s, "scribePage");
        e0e.f((Object)s2, "scribeSection");
    ...
    public boolean equals(final Object o) {
        ...
        return this.educationOnly == leaveConversationPromptArgs.educationOnly && e0e.a((Object)this.tweetId, (Object)leaveConversationPromptArgs.tweetId) && e0e.a((Object)this.scribePage, (Object)leaveConversationPromptArgs.scribePage) && e0e.a((Object)this.scribeSection, (Object)leaveConversationPromptArgs.scribeSection);
    }
    ...
    public int hashCode() {
        ...
        return this.scribeSection.hashCode() + brg.d(this.scribePage, (educationOnly * 31 + hashCode) * 31, 31);
    }
    ...
    public String toString() {
        ...
        return m58.v(sb, scribePage, ", scribeSection=", scribeSection, ")");
    }
}

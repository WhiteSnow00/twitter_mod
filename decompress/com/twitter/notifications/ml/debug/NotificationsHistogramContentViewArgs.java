...
@bmp
@Metadata(bv = {}, d1 = { "\u0000@\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0004\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0007\n\u0002\u0018\u0002\n\u0002\b\u0005\b\u0087\b\u0018\u0000 \u001d2\u00020\u0001:\u0002\u001e\u001dB\u0011\u0012\b\b\u0002\u0010\u000b\u001a\u00020\t¢\u0006\u0004\b\u0017\u0010\u0018B%\b\u0017\u0012\u0006\u0010\u0019\u001a\u00020\u000e\u0012\b\u0010\u000b\u001a\u0004\u0018\u00010\t\u0012\b\u0010\u001b\u001a\u0004\u0018\u00010\u001a¢\u0006\u0004\b\u0017\u0010\u001cJ!\u0010\b\u001a\u00020\u00072\u0006\u0010\u0002\u001a\u00020\u00002\u0006\u0010\u0004\u001a\u00020\u00032\u0006\u0010\u0006\u001a\u00020\u0005H\u00c7\u0001J\t\u0010\n\u001a\u00020\tH\u00c6\u0003J\u0013\u0010\f\u001a\u00020\u00002\b\b\u0002\u0010\u000b\u001a\u00020\tH\u00c6\u0001J\t\u0010\r\u001a\u00020\tH\u00d6\u0001J\t\u0010\u000f\u001a\u00020\u000eH\u00d6\u0001J\u0013\u0010\u0013\u001a\u00020\u00122\b\u0010\u0011\u001a\u0004\u0018\u00010\u0010H\u00d6\u0003R\u0017\u0010\u000b\u001a\u00020\t8\u0006¢\u0006\f\n\u0004\b\u000b\u0010\u0014\u001a\u0004\b\u0015\u0010\u0016¨\u0006\u001f" }, d2 = { "Lcom/twitter/notifications/ml/debug/NotificationsHistogramContentViewArgs;", "Lcom/twitter/app/common/args/ContentViewArgs;", "self", "Lee6;", "output", "Lkotlinx/serialization/descriptors/SerialDescriptor;", "serialDesc", "Lvzv;", "write$Self", "", "component1", "thing", "copy", "toString", "", "hashCode", "", "other", "", "equals", "Ljava/lang/String;", "getThing", "()Ljava/lang/String;", "<init>", "(Ljava/lang/String;)V", "seen1", "Ldmp;", "serializationConstructorMarker", "(ILjava/lang/String;Ldmp;)V", "Companion", "$serializer", "subsystem.tfa.notifications.ml.api_release" }, k = 1, mv = { 1, 7, 1 })
public final class NotificationsHistogramContentViewArgs implements ContentViewArgs
{
    ...
    public NotificationsHistogramContentViewArgs(final int n, final String thing, final dmp dmp) {
        if ((n & 0x0) == 0x0) {
            if ((n & 0x1) == 0x0) {
                this.thing = "";
            }
    ...
    public NotificationsHistogramContentViewArgs(final String thing) {
        e0e.f((Object)thing, "thing");
        this.thing = thing;
    }
    
    public NotificationsHistogramContentViewArgs(String s, final int n, final wg8 wg8) {
        if ((n & 0x1) != 0x0) {
            s = "";
        }
        this(s);
    ...
    public static final void write$Self(final NotificationsHistogramContentViewArgs notificationsHistogramContentViewArgs, final ee6 ee6, final SerialDescriptor serialDescriptor) {
        e0e.f((Object)notificationsHistogramContentViewArgs, "self");
        e0e.f((Object)ee6, "output");
        e0e.f((Object)serialDescriptor, "serialDesc");
        boolean b = false;
        Label_0050: {
            if (!ee6.z(serialDescriptor)) {
                if (e0e.a((Object)notificationsHistogramContentViewArgs.thing, (Object)"")) {
                    b = false;
                    break Label_0050;
                }
            }
        ...
        if (b) {
            ee6.S(serialDescriptor, 0, notificationsHistogramContentViewArgs.thing);
        }
    }
    ...
    public final NotificationsHistogramContentViewArgs copy(final String s) {
        e0e.f((Object)s, "thing");
        return new NotificationsHistogramContentViewArgs(s);
    }
    
    @Override
    public boolean equals(final Object o) {
        return this == o || (o instanceof NotificationsHistogramContentViewArgs && e0e.a((Object)this.thing, (Object)((NotificationsHistogramContentViewArgs)o).thing));
    }
    ...
    public String toString() {
        return c0e.h("NotificationsHistogramContentViewArgs(thing=", this.thing, ")");
    }
    
    @Metadata(bv = {}, d1 = { "\u00004\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0011\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0006\b\u00c7\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0013\u0010\u0014J\u001a\u0010\u0005\u001a\f\u0012\b\u0012\u0006\u0012\u0002\b\u00030\u00040\u0003H\u00d6\u0001¢\u0006\u0004\b\u0005\u0010\u0006J\u0011\u0010\t\u001a\u00020\u00022\u0006\u0010\b\u001a\u00020\u0007H\u00d6\u0001J\u0019\u0010\u000e\u001a\u00020\r2\u0006\u0010\u000b\u001a\u00020\n2\u0006\u0010\f\u001a\u00020\u0002H\u00d6\u0001R\u0014\u0010\u0012\u001a\u00020\u000f8VX\u00d6\u0005¢\u0006\u0006\u001a\u0004\b\u0010\u0010\u0011¨\u0006\u0015" }, d2 = { "com/twitter/notifications/ml/debug/NotificationsHistogramContentViewArgs.$serializer", "Lezb;", "Lcom/twitter/notifications/ml/debug/NotificationsHistogramContentViewArgs;", "", "Lkotlinx/serialization/KSerializer;", "childSerializers", "()[Lkotlinx/serialization/KSerializer;", "Lkotlinx/serialization/encoding/Decoder;", "decoder", "deserialize", "Lkotlinx/serialization/encoding/Encoder;", "encoder", "value", "Lvzv;", "serialize", "Lkotlinx/serialization/descriptors/SerialDescriptor;", "getDescriptor", "()Lkotlinx/serialization/descriptors/SerialDescriptor;", "descriptor", "<init>", "()V", "subsystem.tfa.notifications.ml.api_release" }, k = 1, mv = { 1, 7, 1 })
    public static final class $serializer implements ezb<NotificationsHistogramContentViewArgs>
    {
        public static final $serializer INSTANCE;
        public static final SerialDescriptor descriptor;
        
        static {
            final fpk descriptor2 = new fpk("com.twitter.notifications.ml.debug.NotificationsHistogramContentViewArgs", (ezb)(INSTANCE = new $serializer()), 1);
        ...
        public KSerializer<?>[] childSerializers() {
            return (KSerializer<?>[])new KSerializer[] { (KSerializer)dlr.a };
        }
        ...
        public void serialize(final Encoder encoder, final NotificationsHistogramContentViewArgs notificationsHistogramContentViewArgs) {
            ...
            e0e.f((Object)notificationsHistogramContentViewArgs, "value");
            final SerialDescriptor descriptor = this.getDescriptor();

...
public final class ModelViewer implements View$OnTouchListener
{
    ...
    public ModelViewer(final SurfaceView surfaceView, final Engine engine, final UiHelper uiHelper, final Manipulator manipulator) {
        e0e.f((Object)surfaceView, "surfaceView");
        e0e.f((Object)engine, "engine");
        e0e.f((Object)uiHelper, "uiHelper");
    ...
    public ModelViewer(final SurfaceView surfaceView, Engine create, UiHelper uiHelper, Manipulator manipulator, final int n, final wg8 wg8) {
        if ((n & 0x2) != 0x0) {
    ...
    public ModelViewer(final TextureView textureView, final Engine engine, final UiHelper uiHelper, final Manipulator manipulator) {
        e0e.f((Object)textureView, "textureView");
        e0e.f((Object)engine, "engine");
        e0e.f((Object)uiHelper, "uiHelper");
        this(engine, uiHelper);
        Manipulator build = manipulator;
    ...
    public ModelViewer(final TextureView textureView, Engine create, UiHelper uiHelper, Manipulator manipulator, final int n, final wg8 wg8) {
        if ((n & 0x2) != 0x0) {
            create = Engine.create();
            e0e.e((Object)create, "create()");
        }
    ...
    public ModelViewer(final Engine engine, final UiHelper uiHelper) {
        ...
        e0e.e((Object)renderer, "engine.createRenderer()");
        this.renderer = renderer;
        final Scene scene = engine.createScene();
        e0e.e((Object)scene, "engine.createScene()");
        this.scene = scene;
        final Camera camera = engine.createCamera(engine.getEntityManager().create());
        e0e.e((Object)camera, "engine.createCamera(engine.entityManager.create())");
        camera.setExposure(16.0f, 0.008f, 100.0f);
        this.camera = camera;
        final View view = engine.createView();
        e0e.e((Object)view, "engine.createView()");
    ...
    public static final Object access$fetchResources(final ModelViewer modelViewer, final FilamentAsset filamentAsset, final stb stb, final mp6 mp6) {
        return modelViewer.fetchResources(filamentAsset, (stb<? super String, ? extends Buffer>)stb, (mp6<? super vzv>)mp6);
    }
    ...
    private final Object fetchResources(final FilamentAsset filamentAsset, final stb<? super String, ? extends Buffer> stb, final mp6<? super vzv> mp6) {
        final HashMap hashMap = new HashMap();
        final String[] resourceUris = filamentAsset.getResourceUris();
        e0e.e((Object)resourceUris, "asset.resourceUris");
        final int length = resourceUris.length;
        int i = 0;
        while (i < length) {
            final String s = resourceUris[i];
            ++i;
            e0e.e((Object)s, "resourceUri");
            hashMap.put(s, stb.invoke((Object)s));
        }
        final nk8 a = j29.a;
        final Object t = ma7.T((yy6)aig.a, (hub)new ModelViewer$fetchResources.ModelViewer$fetchResources$2(hashMap, this, filamentAsset, (mp6)null), (mp6)mp6);
        if (t == jz6.F0) {
            return t;
        }
        return vzv.a;
    ...
    private final void populateScene(final FilamentAsset filamentAsset) {
        ...
        e0e.e((Object)renderableManager, "engine.renderableManager");
        final c8m c8m = new c8m();
        while (((ptb)new ModelViewer$populateScene$popRenderables.ModelViewer$populateScene$popRenderables$1(c8m, filamentAsset, this)).invoke()) {
            int n = 0;
            final int n2 = c8m.F0 - 1;
            if (n2 >= 0) {
                while (true) {
            ...
            this.scene.addEntities(rr4.h2((Collection)ft0.j1(this.readyRenderables, c8m.F0)));
        }
    ...
    private final void updateCameraProjection() {
        this.camera.setLensProjection((double)this.cameraFocalLength, this.view.getViewport().width / (double)this.view.getViewport().height, 0.05, 1000.0);
    }
    ...
    public final void clearRootTransform() {
        ...
        if (asset != null) {
            ...
            e0e.e((Object)transformManager, "engine.transformManager");
    ...
    public final void destroyModel() {
        final iae fetchResourcesJob = this.fetchResourcesJob;
        if (fetchResourcesJob != null) {
            iae$a.a(fetchResourcesJob, (CancellationException)null, 1, (Object)null);
        }
    ...
    public final void loadModelGltf(final Buffer buffer, final stb<? super String, ? extends Buffer> stb) {
        e0e.f((Object)buffer, "buffer");
        e0e.f((Object)stb, "callback");
        this.destroyModel();
        ...
        if (assetFromJson != null) {
            ...
            while (i < resourceUris.length) {
                ...
                ++i;
                e0e.e((Object)s, "uri");
                final Buffer buffer2 = (Buffer)stb.invoke((Object)s);
                if (buffer2 == null) {
                    this.asset = null;
                    return;
                }
    ...
    public final void loadModelGltfAsync(final Buffer buffer, final stb<? super String, ? extends Buffer> stb) {
        e0e.f((Object)buffer, "buffer");
        e0e.f((Object)stb, "callback");
        this.destroyModel();
        this.asset = this.assetLoader.createAssetFromJson(buffer);
        this.fetchResourcesJob = ma7.D(r1n.e((yy6)j29.c), (yy6)null, 0, (hub)new ModelViewer$loadModelGltfAsync.ModelViewer$loadModelGltfAsync$1(this, (stb)stb, (mp6)null), 3);
    }
    ...
    public final void transformToUnitCube(Float3 float3) {
        e0e.f((Object)float3, "centerPoint");
        final FilamentAsset asset = this.asset;
        if (asset != null) {
            final TransformManager transformManager = this.getEngine().getTransformManager();
            e0e.e((Object)transformManager, "engine.transformManager");
